  ...
  <div class="layout">
    ...
    <main class="main">
      <section id="tab-overview" class="tab active card section">
        ...
        <div class="diagnostics"><div class="diagnostics-summary"><span>本机运行环境</span><b id="diagnostics-title">尚未运行诊断</b><span id="diagnostics-subtitle">遇到安装、训练或导出问题时先在这里检查。</span><div><button id="diagnostics-button" class="btn" onclick="loadSystemDiagnostics(true)">运行系统诊断</button></div></div><div id="diagnostics-detail" class="diagnostics-detail"><span class="diagnostic-chip">Python</span><span class="diagnostic-chip">PyTorch / CUDA</span><span class="diagnostic-chip">Ultralytics</span><span class="diagnostic-chip">ONNX Runtime</span></div></div>
      </section>
