...
DEVICE_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "drobotics_rdk_x5": {
        ...
        "vendor_ptq": True,
        "forced_int8": True,
        "summary": "平台准备官方转换包；最终产物是 Bayes-e BPU 可运行的 INT8 .bin，而不是 ONNX。",
        "next_step": "在 x86 Ubuntu 22.04 的 RDK X5 OpenExplorer 中运行转换脚本，再用 hrt_model_exec 校验和测速。",
        ...
        "conversion_location": "x86_64 Ubuntu 22.04 / OpenExplorer",
        "workflow": ["训练并保留 .pt", "生成官方 PTQ 转换包", "编译并校验 .bin", "复制到 RDK X5"],
    },
    "maixcam": {
