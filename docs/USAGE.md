...
“工作台总览 → 软件更新”会显示当前版本和 GitHub 最新 Release 的更新内容。自动检查间隔至少 6 小时，也可点击“检查更新”；桌面版下载后会校验官方仓库地址、文件大小、内部版本和 GitHub 提供的 SHA-256，再询问是否安装。断网或 GitHub 暂时不可访问时只显示检查失败，不影响本地功能。
